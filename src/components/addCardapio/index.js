...
import AddIngredientePopup from "./SelecionarIngredientesComQuantidade";
...
function Cardapio(data){
    ...
    async function findCardapio() {
        ...
        if(data.id != null){
            ...
            setIngredientesSelecionados(cardapio.data.ingredientes)
            setIsActive(cardapio.data.ativo)
        }
    ...
    async function EditCardapio(){
        if (!NomeCardapio ) {                      
            ...
            try{
                console.log(NomeCardapio, setorSelecionado, DescricaoCardapio, PrecoCardapio, ingredientesSelecionados)
        ...
        <Overlay>
            <Container>
                <div className="popup-header">
                    <Close onClick={close}>
                        <img src="https://static.xx.fbcdn.net/rsrc.php/v3/y2/r/__geKiQnSG-.png"  onClick={close} width="24" height="24" alt="fechar"/>
                    </Close>
                ...
                <div className="popup-footer">
                    <div className="_1lch">
                        ...
                        <button type="submit" onClick={buttonAction} disabled={allError ? true : false} className="_6j mvm _58mi _6o _6wl _6v" name="websubmit" id="u_6_s_PY">
